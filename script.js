...
const customers = [
{title: 'Arun', id: 1, job: 'developer'},
{title: 'Kishore', id: 2, job:'manager'},
{title: 'Surya', id: 3, job:'tester'},
{title: 'Bhanu', id: 4, job:'engineer'},
{title: 'Naveen', id: 5, job:'Senior engineer'}
]
 
//Read Request Handlers
// Display the Message when the URL consist of '/'
app.get('/', (req, res) => {
res.send('Welcome to Customers Data!');
});
